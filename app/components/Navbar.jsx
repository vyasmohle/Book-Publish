...
//         <span className="font-sans font-semibold">Scholint</span>{" "}
//         Publishers
//       </h1>
...
//                         className="absolute left-0 top-5 w-44 bg-white border border-gray-300 rounded-md shadow-xl text-sm z-50"
//                       >
//                         <li>
//                           <Link
...
export default function Navbar() {
  ...
  return (
    <header className="w-full fixed top-0 left-0 z-50 bg-white shadow-sm">
      {/* ======= Top Bar: Logo + Title ======= */}
      {/* <div className="flex flex-col sm:flex-row items-center justify-between border-b border-gray-200 px-4 sm:px-6 md:px-8 py-2">
        <div className="flex items-center gap-3 justify-center sm:justify-start">
          <Link href="/">
            <img
              src="/images/logo-2.png"
              alt="Scholint Logo"
              className="h-16 w-auto sm:h-20 object-contain cursor-pointer"
            />
          </Link>
          <div className="text-center sm:text-left">
            <h1 className="text-xl sm:text-2xl md:text-3xl font-sans">
              <span className="font-semibold">Scholint</span> Publishers
            </h1>
